// Assets imports for proper bundling
import sleeveTextureUrl from '../assets/images/sleeve.png';
import woodTextureUrl from '../assets/images/wood.jpg';
...
export default {
  ...
  sleeveMaskTexture: sleeveTextureUrl,
  crateTexture: woodTextureUrl,
